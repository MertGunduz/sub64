...
\DoxyCodeLine{\Hypertarget{help__menu_8c_source_l00019}00019     fprintf(stdout, \textcolor{stringliteral}{"{}encrypt/decrypt text or files via base64/random substitution\(\backslash\)n\(\backslash\)n"{}});}
